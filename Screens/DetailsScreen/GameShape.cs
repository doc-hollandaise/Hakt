...
public class GameShape
{
    ...
    public GameShape(Vector2 position, float radius, Color color, string label, Texture2D image, Game1 game)
    {
        Position = position;
        Radius = radius;
        Color = color;
    ...
    public GameShape(System.Numerics.Vector2 position, float radius, Color borderColor, string label)
    {
        Position = position;
        Radius = radius;
